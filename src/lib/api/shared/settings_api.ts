...
export type SizeOptionModels =
  ...
  | "List_Medium"
  | "List_Large";
export const SizeOptionModelsAsList = [
  "Grid_Small",
  "Grid_Medium",
  "Grid_Large",
  "List_Small",
...
export function convertOrderOptionGroupsToEnum(
  orderOption: OrderOptionGroups,
): GroupOrderBy {
  switch (orderOption) {
    case "date-asc":
