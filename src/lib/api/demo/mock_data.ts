...
import type { DemoBlob } from "./blob";
...
const mockModelDataList: MockModelData[] = [
  {
    ...
    size: "10.8 MB",
    sourceUrl:
      "https://www.printables.com/model/2236-3dbenchy-the-jolly-3d-printing-torture-test-by-cre",
  },
  {
    name: "Calibration Cube",
    modelUrl: "https://meshdemo.suchmeme.nl/mock_data/Calibration Cube.3mf",
    thumbnailUrl:
      "https://meshdemo.suchmeme.nl/mock_data/Calibration Cube.3mf.png",
    size: "4.5 KB",
  ...
  },
  {
    ...
    thumbnailUrl:
      "https://meshdemo.suchmeme.nl/mock_data/Embossed text.stl.png",
    size: "69.2 KB",
  },
  {
    name: "Temp Tower PLA",
    ...
    thumbnailUrl:
      "https://meshdemo.suchmeme.nl/mock_data/Temp Tower PLA.stl.png",
    size: "2.1 MB",
    sourceUrl:
      "https://www.printables.com/model/274675-temp-tower-explanations",
  },
  {
    name: "Beer Crate AA",
    modelUrl: "https://meshdemo.suchmeme.nl/mock_data/beer_crate_AA.stl",
    thumbnailUrl:
      "https://meshdemo.suchmeme.nl/mock_data/beer_crate_AA.stl.png",
    size: "237.8 KB",
    sourceUrl:
  ...
  },
  {
    ...
    modelUrl:
      "https://meshdemo.suchmeme.nl/mock_data/ECC_0.4_Korper1_PLA0.2_12m19s.gcode",
    thumbnailUrl:
      "https://meshdemo.suchmeme.nl/mock_data/ECC_0.4_Korper1_PLA0.2_12m19s.gcode.png",
    size: "369.0 KB",
    sourceUrl: "https://www.printables.com/model/118657-calibration-cube",
  },
  {
