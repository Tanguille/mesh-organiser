...
- **STEP/OCCT**: Handled by cadrum — Windows and macOS download a prebuilt OCCT, Linux builds it from source once (cached afterwards); see [docs/commands.md](docs/commands.md).
